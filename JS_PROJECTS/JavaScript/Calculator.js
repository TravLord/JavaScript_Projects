...
function Handle_Operator(Next_Operator) {
    ...
    //Calculatot.First_Operand if it doesn't already exist. 
    ...
    if (First_Operand == null) { 
        ...
        //here we add fixed amount of numbers after the dedimal
    ...
    Update_Display();
    //this section montiors button clicks 
    ...
    keys.addEventListener('click', (event) => {
        ...
        //This ensures that AC clears the numbers from the Calculator
