...
let activePlayer = "X";
//This array stores an arrray of moves. We use this to determine win conditions.
let selectedSquares =[];

//This function is for placing an x or o in the square.
function placeXOrO(squareNumber) {
    // This condition ensures a square hasn't been selcted already. 
    ...
    if(!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if(activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/small-letter-x-new.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'        
        } else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML.
            select.style.backgroundImage = 'url("images/letter_o_PNG126.png")';
        }
...
function disableClick() {
    ...
    //This mkaes our body clickable again after 1 second.
...
function drawWinLine (coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1= coordX1,
        ...
        y1= coordY1,
        //This lines indicates where the end of the lines x axis is.
        x2= coordX2,
        //This lines indicates where the end of the lines x axis is.
        y2=coordY2,
        //This variable temporary x axis data we update in our animation loop.
        x = x1, 
        //This variable temporary y axis data we update in our animation loop.
        y=y1; 
    ...
    function animateLineDrawing() {
        ...
        c.beginPath();
        // This method indicates the starting point for our line.
        c.moveTo(x1, y1)
        ...
        c.stroke();
        // This condtion checks if we've reached the endpoint.
        if (x1 <= x2 && y1 <= y2) {
